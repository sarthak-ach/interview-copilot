...
import { Bot, Mail, Lock, User, Eye, EyeOff, ArrowRight, AlertCircle, Loader2, Sun, Moon } from "lucide-react";
    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12 text-ink sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1.5 text-sm text-moss font-medium">Start practicing mock interviews and system design</p>
        </div>
        ...
        <div className="rounded-2xl border border-line bg-panel/90 p-8 shadow-soft backdrop-blur-md">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label htmlFor="fullName" className="text-xs font-bold uppercase tracking-wider text-ink/60">
                Full Name
              </label>
            ...
            <div className="space-y-1.5">
              <label htmlFor="confirmPassword" className="text-xs font-bold uppercase tracking-wider text-ink/60">
                Confirm Password
              </label>
              <div className="relative rounded-lg">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-ink/40">
            ...
            <button
              ...
              className="flex w-full mt-2 h-11 items-center justify-center gap-2 rounded-lg bg-ink text-shell font-semibold text-sm transition hover:bg-moss hover:scale-[1.01] active:scale-[0.99] disabled:bg-ink/50 disabled:scale-100 disabled:cursor-not-allowed shadow-sm cursor-pointer"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="mt-6 text-center border-t border-line/60 pt-4">
            <p className="text-sm text-ink/60">
              ...
              <Link href="/login" className="font-semibold text-moss hover:underline hover:text-ink transition">
                Log In
              </Link>
            </p>
          </div>
